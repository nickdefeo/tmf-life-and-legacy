...
export default function About() {
  return (
    <section id="about" className="section-pad bg-black-soft">
      <div className="container-tmf grid items-center gap-14 lg:grid-cols-2">
        ...
        <Reveal className="relative flex justify-center lg:justify-start">
          ...
          <div className="relative rounded-3xl border border-goldline bg-black-card p-12 shadow-card">
            <Image
              src={brand.logo.src}
              alt={brand.logo.alt}
              width={750}
        ...
        <div>
          ...
          <div className="mt-6 space-y-5">
            {about.body.map((para, i) => (
              <Reveal key={i} delay={i * 0.08}>
                <p className="text-base leading-relaxed text-ivory-muted">{para}</p>
              </Reveal>
            ))}
          </div>
          ...
          <Reveal delay={0.2}>
            <div className="mt-8 border-l-2 border-gold pl-5">
              <p className="font-cormorant text-2xl italic text-gold-metallic">
                {about.pullQuote}
              </p>
            </div>
          </Reveal>
